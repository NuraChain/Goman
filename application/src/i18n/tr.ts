...
export const tr: Dictionary = {
    ...
    admin: {
        ...
        sectionAccess: 'Erişim',
        accessTitle: 'Kimler pazar hazırlayabilir',
        accessHint:
        ...
        accessGrant: 'Davet et',
        accessRevoke: 'Kaldır',
        accessInvalid: 'Bu bir cüzdan adresi değil',
        accessAlready: 'Bu cüzdan zaten listede',
        accessEmpty: 'Henüz kimse yok, yani oluşturma formunu yalnızca yöneticiler açabilir.',
        accessCreateLink: 'Oluşturma bağlantısını kopyala',
        accessCreateLinkHint: 'Davetle birlikte gönderin - karşı tarafta oluşturma formunu açar.',
        contributorTitle: 'Pazar hazırla',
        contributorHint:
            'Burayı doldur ve gönder. Sahibi kontrol edip yayına almayı imzalar; buradan hiçbir şey kendiliğinden zincire gitmez.',
        contributorNoDeploy: 'Bu cüzdan yayına alamaz. Öneri olarak gönder, sahibi imzalasın.',
        stepquestion: 'Soru',
        ...
        proposedTitle: 'Öneri gönderildi',
        proposedHint: 'Kuyrukta. Sahibi ya yayına alır ya da gerekçesiyle geri gönderir.',
        proposeAgain: 'Bir tane daha yaz',
        proposalsTitle: 'Önerilen pazarlar',
        proposalsHint:
            'Yayına alma yetkisi olmayan cüzdanların yazdığı pazarlar. Gönderdiğinde oluşturma formu bütün alanlar dolu açılır; imzalamadan önce istediğini düzeltirsin.',
        proposalsEmpty: 'Henüz öneri yok',
        proposalsEmptyHint: 'Erişim sekmesinden bir cüzdan davet et; yazdıkları buraya düşer.',
        proposalUntitled: 'Başlıksız pazar',
        proposalPending: 'Bekliyor',
        proposalAccepted: 'Kabul edildi',
        proposalDeclined: 'Reddedildi',
        proposalSubmit: 'Gönder',
        proposalDecline: 'Reddet',
        proposalNote: 'Gerekçe (isteğe bağlı)',
        proposalNoteHint: 'Bunu neyin düzelteceği',
        myProposalsTitle: 'Önerdiklerin',
        myProposalsHint: 'Sahibi bunları yayına alır ya da geri gönderir. Gerekçe yazdıysa burada görünür.',
