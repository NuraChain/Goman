...
export const tr: Dictionary = {
    ...
    admin: {
        ...
        discoverTopic: 'Konu',
        discoverTopicAll: 'Tüm konular',
        topicPolitics: 'Siyaset',
        topicElections: 'Seçimler',
        topicGeopolitics: 'Jeopolitik',
        topicWorld: 'Dünya',
        topicEconomy: 'Ekonomi',
        topicBusiness: 'İş dünyası',
        topicCrypto: 'Kripto',
        topicBitcoin: 'Bitcoin',
        topicTech: 'Teknoloji',
        topicAi: 'Yapay zekâ',
        topicScience: 'Bilim',
        topicWeather: 'Hava durumu',
        topicSports: 'Spor',
        topicEsports: 'Espor',
        topicPopCulture: 'Popüler kültür',
        topicMovies: 'Sinema',
        topicMusic: 'Müzik',
        denied: 'Yetkiniz yok',
        ...
        categoriesHint:
            'Bir kategori ID’si, etiketlediği her piyasayla birlikte zincire gider ve asla yeniden adlandırılamaz. Buradaki her şey sunumdur: görünen ad, sıra ve seçicilerde hâlâ görünüp görünmediği.',
