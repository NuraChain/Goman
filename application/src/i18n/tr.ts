...
export const tr: Dictionary = {
    ...
    admin: {
        ...
        accessHint:
            'Bu cüzdanlar oluşturma formunu açıp doldurabilir. Hiçbir şeyi yayına alamazlar - taslağı size bağlantı olarak gönderirler, imzalayan sizsiniz.',
        accessNoChain:
        ...
        contributorHint:
            'Bunu doldurun, sonra bağlantıyı bir yöneticiye gönderin. O kontrol edip yayına almayı imzalar; buradan hiçbir şey kendiliğinden zincire gitmez.',
        contributorNoDeploy:
            'Bu cüzdan yayına alamaz. Taslak bağlantısını kopyalayıp imzalaması için bir yöneticiye gönderin.',
        stepquestion: 'Soru',
