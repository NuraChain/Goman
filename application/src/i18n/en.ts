...
export const en = {
    ...
    admin: {
        ...
        botAdminsTitle: 'Who can command the bot',
        botAdminsHint: 'Anyone can send /help. Only these accounts can suggest a market with /newmarket.',
        botAdminsEmpty: 'Nobody yet, so /newmarket is closed to everyone.',
        botAdminsCount: 'allowed',
        botAdminId: 'Telegram ID',
        botAdminIdInvalid: 'A Telegram ID is digits only. Ask them to send /myid to the bot.',
        botAdminName: 'Name (optional)',
        botAdminAdd: 'Allow',
        botAdminRemove: 'Remove',
        proposalsTitle: 'Suggested markets',
        proposalsHint: 'Sent in over the bot. Approving fills in the create form; you still sign the deploy.',
        proposalsEmpty: 'Nothing suggested',
        proposalsEmptyHint: 'Market suggestions sent to the bot with /newmarket arrive here.',
        proposalsFailed: 'Could not load suggestions',
        proposalsFailedHint: 'The server did not answer. Try again.',
        ...
        proposalRejectConfirm: 'Confirm rejection',
        proposalRejectNote: 'Reason (optional)',
        proposalRejectNoteHint: 'Sent to whoever suggested it',
        proposalNoDate: 'no closing date',
        proposalYesNo: 'Yes / No',
