...
export const en = {
    ...
    admin: {
        ...
        contributorHint:
            'Fill this in and submit it. The owner checks it and signs the deploy; nothing here reaches the chain on its own.',
        contributorNoDeploy: 'This wallet cannot deploy. Submit it as a proposal and the owner signs it.',
        ...
        proposedTitle: 'Proposal submitted',
        proposedHint: 'It is in the queue. The owner either deploys it or sends it back with a reason.',
        proposeAgain: 'Write another',
        proposalsTitle: 'Proposed markets',
        proposalsHint:
            'Markets written by wallets that cannot deploy one. Submitting opens the create form with every field already in, so you can fix anything before you sign.',
        proposalsEmpty: 'Nothing proposed yet',
        proposalsEmptyHint: 'Invite a wallet from the Access tab and whatever they write lands here.',
        proposalUntitled: 'Untitled market',
        proposalPending: 'Waiting',
        proposalAccepted: 'Accepted',
        proposalDeclined: 'Declined',
        proposalSubmit: 'Submit',
        proposalDecline: 'Decline',
        proposalNote: 'Reason (optional)',
        proposalNoteHint: 'What would make this one work',
        myProposalsTitle: 'What you proposed',
        myProposalsHint: 'The owner deploys these or sends them back. A reason appears here when there is one.',
