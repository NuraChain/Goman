...
export const es: Dictionary = {
    ...
    admin: {
        ...
        categoriesHint:
            'El ID de una categoría viaja en la cadena con cada mercado que etiqueta y no se puede renombrar nunca. Todo lo de aquí es presentación: el nombre mostrado, el orden y si sigue apareciendo en los selectores.',
