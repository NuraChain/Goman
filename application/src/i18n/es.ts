...
export const es: Dictionary = {
    ...
    admin: {
        ...
        botAdminsTitle: 'Quién puede dar órdenes al bot',
        botAdminsHint: 'Cualquiera puede enviar /help. Solo estas cuentas proponen un mercado con /newmarket.',
        botAdminsEmpty: 'Todavía nadie, así que /newmarket está cerrado para todos.',
        botAdminsCount: 'permitidos',
        botAdminId: 'ID de Telegram',
        botAdminIdInvalid: 'Un ID de Telegram son solo dígitos. Pídele que envíe /myid al bot.',
        botAdminName: 'Nombre (opcional)',
        botAdminAdd: 'Permitir',
        botAdminRemove: 'Quitar',
        proposalsTitle: 'Mercados propuestos',
        proposalsHint: 'Llegaron por el bot. Aprobar rellena el formulario; la firma del despliegue sigue siendo tuya.',
        proposalsEmpty: 'Nada propuesto',
        proposalsEmptyHint: 'Las propuestas enviadas al bot con /newmarket aparecen aquí.',
        proposalsFailed: 'No se pudieron cargar las propuestas',
        proposalsFailedHint: 'El servidor no respondió. Inténtalo de nuevo.',
        proposalPending: 'Pendientes',
        proposalApproved: 'Aprobadas',
        proposalRejected: 'Rechazadas',
        proposalWaiting: 'esperando',
        proposalApprove: 'Aprobar',
        proposalReject: 'Rechazar',
        proposalRejectConfirm: 'Confirmar rechazo',
        proposalRejectNote: 'Motivo (opcional)',
        proposalRejectNoteHint: 'Se envía a quien lo propuso',
        proposalNoDate: 'sin fecha de cierre',
        proposalYesNo: 'Sí / No',
