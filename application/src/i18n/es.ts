...
export const es: Dictionary = {
    ...
    admin: {
        ...
        accessHint:
            'Estas carteras pueden abrir el formulario de creación y rellenarlo. No pueden desplegar nada: te envían el borrador como un enlace y tú lo firmas.',
        accessNoChain:
        ...
        contributorHint:
            'Rellena esto y envía el enlace a un administrador. Lo revisa y firma el despliegue; nada de aquí llega a la cadena por su cuenta.',
        contributorNoDeploy:
            'Esta cartera no puede desplegar. Copia el enlace del borrador y envíalo a un administrador para que lo firme.',
