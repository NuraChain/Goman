...
export const fr: Dictionary = {
    ...
    admin: {
        ...
        botAdminsTitle: 'Qui peut commander le bot',
        botAdminsHint: "N'importe qui peut envoyer /help. Seuls ces comptes proposent un marché avec /newmarket.",
        botAdminsEmpty: 'Personne pour le moment, donc /newmarket est fermé à tous.',
        botAdminsCount: 'autorisés',
        botAdminId: 'ID Telegram',
        botAdminIdInvalid: "Un ID Telegram ne contient que des chiffres. Demandez-lui d'envoyer /myid au bot.",
        botAdminName: 'Nom (facultatif)',
        botAdminAdd: 'Autoriser',
        botAdminRemove: 'Retirer',
        proposalsTitle: 'Marchés proposés',
        proposalsHint:
            'Arrivés par le bot. Approuver remplit le formulaire ; la signature du déploiement reste la vôtre.',
        proposalsEmpty: 'Rien de proposé',
        proposalsEmptyHint: 'Les propositions envoyées au bot avec /newmarket arrivent ici.',
        proposalsFailed: 'Chargement des propositions impossible',
        proposalsFailedHint: "Le serveur n'a pas répondu. Réessayez.",
        proposalPending: 'En attente',
        proposalApproved: 'Approuvées',
        proposalRejected: 'Refusées',
        proposalWaiting: 'en attente',
        proposalApprove: 'Approuver',
        proposalReject: 'Refuser',
        proposalRejectConfirm: 'Confirmer le refus',
        proposalRejectNote: 'Motif (facultatif)',
        proposalRejectNoteHint: "Envoyé à l'auteur de la proposition",
        proposalNoDate: 'sans date de clôture',
        proposalYesNo: 'Oui / Non',
        ...
        formStartHint:
            'Laissez vide pour ouvrir immédiatement. D’ici là le marché est déployé mais en pause, et aucun pari ne passe en avance.',
