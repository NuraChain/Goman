...
export const fr: Dictionary = {
    ...
    browse: {
        ...
        emptyIndex: 'Aucun marché pour l’instant',
        emptyIndexHint: 'Rien n’a encore été créé sur cette chaîne. Le premier apparaîtra ici.',
    ...
    admin: {
        ...
        contributorHint:
            'Remplissez ceci puis envoyez-le. Le propriétaire le vérifie et signe le déploiement ; rien ne part sur la chaîne tout seul.',
        contributorNoDeploy:
            'Ce portefeuille ne peut pas déployer. Envoyez-le en proposition, le propriétaire signera.',
        ...
        proposedTitle: 'Proposition envoyée',
        proposedHint: 'Elle est dans la file. Le propriétaire la déploie ou la renvoie avec un motif.',
        proposeAgain: 'En écrire une autre',
        proposalsTitle: 'Marchés proposés',
        proposalsHint:
            'Des marchés écrits par des portefeuilles qui ne peuvent rien déployer. L’envoi ouvre le formulaire de création, tous champs remplis : vous corrigez ce que vous voulez avant de signer.',
        proposalsEmpty: 'Aucune proposition pour l’instant',
        proposalsEmptyHint: 'Invitez un portefeuille depuis l’onglet Accès : tout ce qu’ils écrivent arrive ici.',
        proposalUntitled: 'Marché sans titre',
        proposalPending: 'En attente',
        proposalAccepted: 'Acceptée',
        proposalDeclined: 'Refusée',
        proposalSubmit: 'Envoyer',
        proposalDecline: 'Refuser',
        proposalNote: 'Motif (facultatif)',
        proposalNoteHint: 'Ce qui la rendrait valable',
        myProposalsTitle: 'Ce que vous avez proposé',
        myProposalsHint: 'Le propriétaire les déploie ou les renvoie. S’il écrit un motif, il apparaît ici.',
