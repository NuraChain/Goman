...
import { render, screen, fireEvent, waitFor } from './harness.ts';
...
const { default: TagField } = await import('../src/components/ui/tag-field.azeroth');
...
describe('TagField', () =>
{
    it('adds what was typed when Enter is pressed', () =>
    {
        ...
        fireEvent.input(field, { target: { value: 'Iran Football' } });
    ...
    it('refuses a second spelling of a tag the market already carries', () =>
    {
        ...
        fireEvent.input(field, { target: { value: 'FOOTBALL' } });
        fireEvent.keyDown(field, { key: 'Enter' });
    ...
    it('takes a pasted comma-separated list as separate tags', () =>
    {
        ...
        fireEvent.input(field, { target: { value: 'football, iran, league' } });
    ...
    it('keeps a backspace that is deleting TEXT away from the tags', () =>
    {
        ...
        fireEvent.input(field, { target: { value: 'ira' } });
        fireEvent.keyDown(field, { key: 'Backspace' });
