...
import { render, waitFor } from './harness.ts';
...
{
    const screen = render(() => App({ url: '/market/will-it-rain-5' }));
    setTimeout(() => writeFileSync('dump2.html', screen.container.innerHTML), 900);
    return screen;
}
